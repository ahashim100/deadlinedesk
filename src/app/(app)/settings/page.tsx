import { getProfile, hasActiveSubscription, requireUser } from '@/lib/auth';
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6">
        ...
        {active ? (
          ...
          <p className="mt-2 text-sm text-slate-500">
            Subscribe to Pro to sync your deadlines to Google, Apple, or Outlook
            Calendar.
          </p>
        )}
      </section>
      ...
      >
        ...
        <p className="mb-5 text-sm text-slate-500">
          Reminders (email &amp; SMS) require an active subscription — $10/month.
          You can add properties and see your dashboard for free.
        </p>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            />
            {active ? 'Reminders active' : 'No active subscription'}
          </span>
        </div>
